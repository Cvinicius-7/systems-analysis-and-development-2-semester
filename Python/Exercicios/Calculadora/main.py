...
but11 = Button(window_frame2, text="-", width=7, height=3, bg=orange, font=("ivy 13 "), relief=RAISED, overrelief=RIDGE);
...
but15 = Button(window_frame2, text="+", width=7, height=3, bg=orange, font=("ivy 13 "), relief=RAISED, overrelief=RIDGE);
but15.place(x=219, y=210);

but16 = Button(window_frame2, text="0", width=14, height=3, bg=white, font=("ivy 13 bold"), relief=RAISED, overrelief=RIDGE);
...
but18 = Button(window_frame2, text="=", width=7, height=3, bg=orange, font=("ivy 13 "), relief=RAISED, overrelief=RIDGE);
